...
class PizzaDelivery:
    ...
    def make_order(self):
        self.ordered = True
        ingredients_unpack = (', '.join([f'{k}: {v}' for k, v in self.ingredients.items()]))
        return f"You've ordered pizza {self.name} prepared with {ingredients_unpack} and the price will be {self.price}lv."
